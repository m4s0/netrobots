...
public class RobotStatus   {
  ...
  private Boolean isWellSpecifiedRobot = null;
  ...
  /**
   **/
  public RobotStatus isWinner(Boolean isWinner) {
   ...
   **/
  public RobotStatus isWellSpecifiedRobot(Boolean isWellSpecifiedRobot) {
    this.isWellSpecifiedRobot = isWellSpecifiedRobot;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "true if the robot creation params respect the constraints.")
  @JsonProperty("isWellSpecifiedRobot")
  public Boolean getIsWellSpecifiedRobot() {
    return isWellSpecifiedRobot;
  }
  public void setIsWellSpecifiedRobot(Boolean isWellSpecifiedRobot) {
    this.isWellSpecifiedRobot = isWellSpecifiedRobot;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, robotStatus.name) &&
        ...
        Objects.equals(this.isWinner, robotStatus.isWinner) &&
        Objects.equals(this.isWellSpecifiedRobot, robotStatus.isWellSpecifiedRobot) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, token, configuration, simulationTime, timeTick, realTimeTick, health, isDead, isWinner, isWellSpecifiedRobot, direction, speed, posX, posY, cannonReloadingTime, firedNewMissile, scanStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("    isWellSpecifiedRobot: ").append(toIndentedString(isWellSpecifiedRobot)).append("\n");
