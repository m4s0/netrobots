...
class RemoveCommand(object):
    ...
    def __init__(self):
        """
        RemoveCommand - a model defined in Swagger
    ...
    def token(self):
        """
        Gets the token of this RemoveCommand.
        ...
        :return: The token of this RemoveCommand.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """
        Sets the token of this RemoveCommand.
        A unique token, that changes after a command is sent from a robot to the server.\nIt is used for recognizing a robot, and chaining the commands, because a robot can not issue another command, before it receive an answer from the server, with the next token to use.\n

        :param token: The token of this RemoveCommand.
        :type: str
        """
        self._token = token
