(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('fireReloadingTime')) {
        obj['fireReloadingTime'] = ApiClient.convertToType(data['fireReloadingTime'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} fireReloadingTime
   */
  exports.prototype['fireReloadingTime'] = undefined;
