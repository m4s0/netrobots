...
class DefaultApi
{
     ...
     * 
     *
     * @return \Swagger\Client\Model\BoardInfo
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function boardEventsGet()
    {
        list($response, $statusCode, $httpHeader) = $this->boardEventsGetWithHttpInfo ();
        return $response; 
    }


    /**
     * boardEventsGetWithHttpInfo
     *
     * 
     *
     * @return Array of \Swagger\Client\Model\BoardInfo, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function boardEventsGetWithHttpInfo()
    {
        
  
        // parse inputs
        $resourcePath = "/board-events";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Swagger\Client\Model\BoardInfo'
            );
            ...
            return array(\Swagger\Client\ObjectSerializer::deserialize($response, '\Swagger\Client\Model\BoardInfo', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\BoardInfo', $e->getResponseHeaders());
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function boardInfoGet()
    {
        list($response, $statusCode, $httpHeader) = $this->boardInfoGetWithHttpInfo ();
        return $response; 
    }


    /**
     * boardInfoGetWithHttpInfo
     *
     * 
     *
     * @return Array of \Swagger\Client\Model\BoardInfo, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function boardInfoGetWithHttpInfo()
    {
        
  
        // parse inputs
        $resourcePath = "/board-info";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
